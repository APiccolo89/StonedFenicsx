...
tol_innerPic      = 1e-2
tol_innerNew      = 1e-5
van_keken_case    = 1 # 1 Van Keken benchmark, When these flag are activated -> default value in all phases -> 3300  
                    # 2 diffusion only, 
                    # 3 composite 
                    # 4 Iterative 
decoupling_ctrl   = 1
...
#---------------------------------------------------------------------------------------------------------
test_name = 'case_Hobson_time_dependent_experiment'
